...
*     Last Modified       :     [2014-12-26 16:33]
...
define(['sensor/erasableMask', 'sensor/env'], function(Mask, Env) {
    ...
    */
    ...
    var configs = {
        ...
        // logo图片
        logoImage: '//bs.baidu.com/public01/bcs-sensor/images/ysld/logo75x40.png',
        ...
        maskImage: '//bs.baidu.com/public01/bcs-sensor/images/ysld/pm_fog_big.png',
        ...
        // 用于擦除的图片
        eraseImage: '//bs.baidu.com/public01/bcs-sensor/images/ysld/bottle.png',

        // 遮盖提示图片
        coverImg: '//bs.baidu.com/public01/bcs-sensor/images/ysld/pm_tip.png',
